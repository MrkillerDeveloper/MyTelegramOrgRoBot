...
class Config:
    ...
    APP_TITLE = os.environ.get("APP_TITLE", "Mytele_ORGbot")
    APP_SHORT_NAME = os.environ.get("APP_SHORT_NAME", "Mytele_ORGbot")
    APP_URL = os.environ.get("APP_URL", "https://telegram.dog/Mytele_ORGbot")
    ...
    # please reopen
    # https://github.com/harshil8981/MyTelegramOrgRoBot
